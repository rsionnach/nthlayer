...
- Semantic conventions for AI decision telemetry (OTel attributes)
...
8. Integration with OpenSRM (optional, for teams that want SLO contracts)
9. Adapters (how to connect to different agent systems)
10. OpenSRM Ecosystem (how the Arbiter relates to NthLayer, SitRep, Mayday, with integration diagram)
11. Prior art (Guardian in GasTown, link to PR #2263)
12. Contributing
...
6. Agentic inference (planned: model proposes manifest, NthLayer generates from it)
7. OpenSRM ecosystem (how it relates to Arbiter, SitRep, Mayday)
8. Contributing

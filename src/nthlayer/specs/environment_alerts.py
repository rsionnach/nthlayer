...
def filter_alerts_by_environment(
    ...
    filtered = [
        ...
        if alert.severity.lower() in allowed_severities
    ]
...
def get_alert_count_estimate(
    ...
    """
    # This would need to actually load alerts from the loader
    # For now, return estimates based on typical distributions
    
    # Typical alert distribution (approximate)
    typical_counts = {
    ...
    counts = typical_counts.get(technology, {"critical": 5, "warning": 7, "info": 3})
